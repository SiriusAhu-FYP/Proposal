...
To ensure the final deliverables meet rigorous engineering standards, specific performance benchmarks have been defined as the acceptance criteria. These targets, outlined in \autoref{tab:eval_metrics}, prioritize architectural viability and baseline competency.

\begin{table}[H]
    \centering
    \renewcommand{\arraystretch}{1.4}
    \setlength{\tabcolsep}{10pt}
    \caption{Evaluation Metrics and Project Targets}
    \label{tab:eval_metrics}
    \begin{tabular}{p{0.2\textwidth} p{0.55\textwidth} p{0.2\textwidth}}
        \hline \hline
        \textbf{Metric} & \textbf{Definition \& Context} & \textbf{Project Target} \\ 
        \hline
        
        \textbf{Task Success Rate \newline (TSR)} & 
        The ratio of successfully completed tasks like \newline ``Collect some wood'' to total attempts. & 
        \textbf{$> 70\%$}\\ 
        
        \textbf{System Latency} & 
        Total time-to-action. Explicitly includes screen capture, network transmission, remote VLM inference, and local execution overhead. & 
        \textbf{$< 3$ s}\\ 
        
        \textbf{Action Accuracy \newline (Validity)} & 
        The percentage of generated actions that are syntactically valid and executable. & 
        \textbf{$> 90\%$}\\ 
        \hline \hline
    \end{tabular}
\end{table}

\noindent Guided by these success metrics, the final deliverables for this project will consist of four main components:
\begin{itemize}
...
\picHere{assets/images/gantt_chart.png}{1.0\textwidth}{Gantt Chart of Project Timeline}{fig:gantt-chart}
