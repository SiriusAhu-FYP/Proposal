...
\renewcommand{\TemplateReportTitle}{Player-Aware Intelligent Monitoring and Operations Navigator}
\renewcommand{\TemplateAuthorName}{Taimingwang Liu}
\renewcommand{\TemplateSupervisorName}{Xihan Bian}
\renewcommand{\TemplateAuthorID}{2037690}
